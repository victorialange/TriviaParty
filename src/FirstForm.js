...
//                 {/* FORM CONTAINER */}
//                 <div className={`${props.initialIntro === props.next ? "content formContainer" : "noContent"} ${limitSubmit === true ? "submitAlert" : ""}`}>
        
        
//                     {/* FORM WITH API CONTENT for quiz  */}
//                     <form onSubmit={submitHandler} aria-label="quiz" 
//                     className={`
//                     ${props.initialIntro === props.next ? "content" : "noContent"}
